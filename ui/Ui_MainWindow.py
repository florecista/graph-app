...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphView = QWidget(self.tabGraph)
        ...
        self.dockWidgetPalette.setMinimumSize(QSize(200, 314))
        self.dockWidgetPalette.setMaximumSize(QSize(400, 524287))
